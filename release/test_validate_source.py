...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="kuberploy-installer-lock-validation-") as temporary:
        ...
        validate_installer_dependency_source(fixture, "0.1.0-rc.236")
    ...
    with tempfile.TemporaryDirectory(prefix="kuberploy-stable-qualification-") as temporary:
        ...
        validate_stable_qualification(qualification_root, "0.1.0-rc.236")
        try:
        ...
        valid_receipt = {
            "candidateVersion": "0.1.0-rc.236",
            "candidateTag": "v0.1.0-rc.236",
