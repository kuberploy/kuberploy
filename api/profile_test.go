...
func TestAgentProfileIsDeterministicAndFailClosed(t *testing.T) {
	...
	expectedScopes := map[string]string{
		...
		"deleteProject": "app.edit", "createEnvironment": "app.edit", "cloneEnvironment": "app.edit", "deleteEnvironment": "app.edit", "createApplication": "app.edit", "deleteApplication": "app.edit", "createImageDeployment": "app.edit", "redeployDeployment": "app.edit", "stopDeployment": "app.edit", "previewImageResolution": "app.edit",
