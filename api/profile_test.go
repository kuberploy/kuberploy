...
func TestAgentProfileIsDeterministicAndFailClosed(t *testing.T) {
	...
	expectedScopes := map[string]string{
		...
		"createEnvironment": "app.edit", "cloneEnvironment": "app.edit", "deleteEnvironment": "app.edit", "createApplication": "app.edit", "deleteApplication": "app.edit", "createImageDeployment": "app.edit", "previewImageResolution": "app.edit",
