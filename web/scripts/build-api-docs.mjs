...
function renderIndex(integrity) {
  return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="./swagger-ui.css" integrity="${integrity["swagger-ui.css"]}" crossorigin="anonymous" />
    <style>
  ...
  <body>
    ...
    <script src="./swagger-ui-bundle.js" integrity="${integrity["swagger-ui-bundle.js"]}" crossorigin="anonymous"></script>
    <script src="./swagger-ui-standalone-preset.js" integrity="${integrity["swagger-ui-standalone-preset.js"]}" crossorigin="anonymous"></script>
    <script>
...
export async function buildApiDocs(outputDirectory) {
  ...
  const indexDocument = renderIndex(integrity);
