  ...
  return (
    <ol className="m-0 p-0 list-none">
      {operations.map((operation) => (
        <li
          key={operation.id}
          className="grid grid-cols-[18px_minmax(0,_1fr)] gap-2 min-h-[73px] [&:last-child_.timeline_rail::after]:hidden"
        >
          ...
          <div className="min-w-0 pb-4 [overflow-wrap:anywhere] [&>div]:flex [&>div]:flex-wrap [&>div]:items-center [&>div]:justify-between [&>div]:gap-2 [&_strong]:text-meta [&_p]:my-1 [&_p]:mx-0 [&_p]:text-ink-soft [&_p]:text-meta [&_p]:leading-[1.45] [&_small]:text-ink-faint [&_small]:text-xs [&_code]:text-[inherit]">
            <div>
