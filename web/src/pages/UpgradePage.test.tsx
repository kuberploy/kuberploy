...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.235 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.235",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.235",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.235.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.235",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.235",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.235",
          api: "0.1.0-rc.235",
          worker: "0.1.0-rc.235",
          web: "0.1.0-rc.235",
          migration: "0.1.0-rc.235",
          upgrader: "0.1.0-rc.235",
          builderAgent: "0.1.0-rc.235",
          chart: "0.1.0-rc.235",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.235 <0.1.0-rc.235",
          kubernetes: {
