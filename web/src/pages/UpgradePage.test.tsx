...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.177 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.177",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.177",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.177.tgz",
  ...
  return {
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.177",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.177",
          api: "0.1.0-rc.177",
          worker: "0.1.0-rc.177",
          web: "0.1.0-rc.177",
          migration: "0.1.0-rc.177",
          upgrader: "0.1.0-rc.177",
          builderAgent: "0.1.0-rc.177",
          chart: "0.1.0-rc.177",
        },
        compatibility: {
