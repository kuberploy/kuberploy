...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.346 --namespace "$NAMESPACE" --values "$VALUES_FILE" --reset-values --server-side=false --wait --timeout 65m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.346",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.346",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.346.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.346",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.346",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.346",
          api: "0.1.0-rc.346",
          worker: "0.1.0-rc.346",
          web: "0.1.0-rc.346",
          migration: "0.1.0-rc.346",
          builderAgent: "0.1.0-rc.346",
          chart: "0.1.0-rc.346",
        },
        compatibility: {
