...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.167 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.167",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.167",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.167.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.166",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.167",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.167",
          api: "0.1.0-rc.167",
          worker: "0.1.0-rc.167",
          web: "0.1.0-rc.167",
          migration: "0.1.0-rc.167",
          upgrader: "0.1.0-rc.167",
          builderAgent: "0.1.0-rc.167",
          chart: "0.1.0-rc.167",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.166 <0.1.0-rc.167",
          kubernetes: {
