...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.216 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.216",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.216",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.216.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.216",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.216",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.216",
          api: "0.1.0-rc.216",
          worker: "0.1.0-rc.216",
          web: "0.1.0-rc.216",
          migration: "0.1.0-rc.216",
          upgrader: "0.1.0-rc.216",
          builderAgent: "0.1.0-rc.216",
          chart: "0.1.0-rc.216",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.216 <0.1.0-rc.216",
          kubernetes: {
