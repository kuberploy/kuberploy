...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.168 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.168",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.168",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.168.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.167",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.168",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.168",
          api: "0.1.0-rc.168",
          worker: "0.1.0-rc.168",
          web: "0.1.0-rc.168",
          migration: "0.1.0-rc.168",
          upgrader: "0.1.0-rc.168",
          builderAgent: "0.1.0-rc.168",
          chart: "0.1.0-rc.168",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.167 <0.1.0-rc.168",
          kubernetes: {
