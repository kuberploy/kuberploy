...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.211 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.211",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.211",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.211.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.211",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.211",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.211",
          api: "0.1.0-rc.211",
          worker: "0.1.0-rc.211",
          web: "0.1.0-rc.211",
          migration: "0.1.0-rc.211",
          upgrader: "0.1.0-rc.211",
          builderAgent: "0.1.0-rc.211",
          chart: "0.1.0-rc.211",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.211 <0.1.0-rc.211",
          kubernetes: {
