...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.266",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.266",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.266.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.266",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.266",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.266",
          api: "0.1.0-rc.266",
          worker: "0.1.0-rc.266",
          web: "0.1.0-rc.266",
          migration: "0.1.0-rc.266",
          upgrader: "0.1.0-rc.266",
          builderAgent: "0.1.0-rc.266",
          chart: "0.1.0-rc.266",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.266 <0.1.0-rc.266",
          kubernetes: {
