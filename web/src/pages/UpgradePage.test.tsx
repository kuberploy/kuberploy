...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.164 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
  ...
  it("does not show a Helm command for an equal release", async () => {
    ...
    vi.spyOn(api, "meta").mockResolvedValue({
      version: "0.1.0-rc.164",
      platformVersion: "0.1.0-rc.164",
      bootstrapRequired: false,
    });
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.164",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.164",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.164.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.163",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.164",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.164",
          api: "0.1.0-rc.164",
          worker: "0.1.0-rc.164",
          web: "0.1.0-rc.164",
          migration: "0.1.0-rc.164",
          upgrader: "0.1.0-rc.164",
          builderAgent: "0.1.0-rc.164",
          chart: "0.1.0-rc.164",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.163 <0.1.0-rc.164",
          kubernetes: {
