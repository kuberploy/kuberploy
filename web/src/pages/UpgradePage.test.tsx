...
describe("platform releases page", () => {
  it("shows an operator Helm command and performs no upgrade-history request", async () => {
    ...
    expect(
      screen.getByText(
        'helm upgrade "$RELEASE_NAME" oci://ghcr.io/kuberploy/charts/kuberploy-installer --version 0.1.0-rc.243 --namespace "$NAMESPACE" --values "$VALUES_FILE" --wait --timeout 20m',
      ),
    ).toBeVisible();
...
function releaseFixture(): LatestPlatformRelease {
  ...
  const chart = {
    ...
    version: "0.1.0-rc.243",
    ociReference: "ghcr.io/kuberploy/charts/kuberploy-installer:0.1.0-rc.243",
    ociDigest: digest,
    package: "kuberploy-installer-0.1.0-rc.243.tgz",
    packageSha256: digest,
  };
  return {
    currentVersion: "0.1.0-rc.243",
    ...
    release: {
      ...
      notesUrl:
        "https://github.com/kuberploy/kuberploy/releases/tag/v0.1.0-rc.243",
      ...
      manifest: {
        ...
        versions: {
          kuberploy: "0.1.0-rc.243",
          api: "0.1.0-rc.243",
          worker: "0.1.0-rc.243",
          web: "0.1.0-rc.243",
          migration: "0.1.0-rc.243",
          upgrader: "0.1.0-rc.243",
          builderAgent: "0.1.0-rc.243",
          chart: "0.1.0-rc.243",
        },
        compatibility: {
          supportedUpgradeFrom: ">=0.1.0-rc.243 <0.1.0-rc.243",
          kubernetes: {
