...
> **Release status:** `0.1.0-rc.3` is a release candidate. Use a dedicated test
...
curl -fsSLo kuberploy-install.sh \
  https://raw.githubusercontent.com/kuberploy/kuberploy/v0.1.0-rc.3/scripts/install.sh
