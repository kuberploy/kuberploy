...
> **Release status:** `0.1.0-rc.307` is a release candidate. Use a dedicated test
...
> installations need [offline recovery](docs/legacy-email-recovery.md) or a
> fresh pre-stable database before local sign-in.
