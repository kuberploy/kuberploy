...
const (
	...
	PermissionRegistryCredentialsRead   Permission = "registry-credentials.read"
	PermissionRegistryCredentialsCreate Permission = "registry-credentials.create"
	PermissionRegistryCredentialsRotate Permission = "registry-credentials.rotate"
	PermissionRegistryCredentialsDelete Permission = "registry-credentials.delete"
