...
func TestRenderFoundationIsDeterministicAndClosed(t *testing.T) {
	...
	for _, required := range []string{"pod-security.kubernetes.io/enforce: restricted", "pod-security.kubernetes.io/enforce-version: v1.31", "name: kuberploy-default-deny", "name: kuberploy-dns-egress", "port: 53", "resources:", "pods/log", "kind: ServiceAccount", "namespace: kuberploy-system"} {
