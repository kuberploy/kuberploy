...
var (
	...
	ErrProjectDeletionBlocked        = fmt.Errorf("%w: project still has dependent resources", ErrConflict)
...
type Store interface {
	...
	DeleteProject(context.Context, string, string, string, string, string, string) (bool, error)
