...
func TestRuntimePolicyDigestFencesRegistryPullProfiles(t *testing.T) {
	disabled, err := projectionpolicy.RuntimePolicyDigest(secrets.RuntimeConfig{}, certificates.ObservationConfig{}, certissuers.ObserverConfig{}, imagepull.RuntimeConfig{}, edge.RuntimeConfig{})
	...
	first, err := projectionpolicy.RuntimePolicyDigest(secrets.RuntimeConfig{}, certificates.ObservationConfig{}, certissuers.ObserverConfig{}, config, edge.RuntimeConfig{})
	if err != nil {
		t.Fatal(err)
	}
	config.Profiles[0].Revision = 2
	second, err := projectionpolicy.RuntimePolicyDigest(secrets.RuntimeConfig{}, certificates.ObservationConfig{}, certissuers.ObserverConfig{}, config, edge.RuntimeConfig{})
