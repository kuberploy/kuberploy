...
{{- else -}}
  ...
  {{- if .Values.foundation.externalDNS.managed -}}
    ...
    {{- end -}}
    {{- range .Values.foundation.networkPolicy.providerEgressCIDRs -}}
      {{- if has . (list "0.0.0.0/0" "::/0") -}}{{ fail "external-dns public defaults must be selected by an empty optional provider CIDR list" }}{{- end -}}
    {{- end -}}
