...
{{- if $foundation.operator.managed -}}
  ...
  {{- if or (ne $eso.image.repository "ghcr.io/external-secrets/external-secrets") (ne $eso.image.tag "v2.8.0") (ne $eso.webhook.image.repository $eso.image.repository) (ne $eso.webhook.image.tag $eso.image.tag) (ne $eso.certController.image.repository $eso.image.repository) (ne $eso.certController.image.tag $eso.image.tag) -}}{{ fail "External Secrets image versions are locked to v2.8.0" }}{{- end -}}
