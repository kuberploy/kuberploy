...
{{- if .Values.argoFoundation.argoCD.managed -}}
  ...
  {{- if or (ne $argo.global.image.repository "quay.io/argoproj/argocd") (ne $argo.global.image.tag "v3.5.0@sha256:c298cedbaeb31532ba8d4e9904eba9e4987e067293fbd86400c5194e78f743d5") -}}{{ fail "Argo CD image is locked by multi-platform digest" }}{{- end -}}
