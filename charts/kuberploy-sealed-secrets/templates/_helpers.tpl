...
{{- if $foundation.controller.managed -}}
  ...
  {{- if or (ne $sealed.image.registry "docker.io") (ne $sealed.image.repository "bitnami/sealed-secrets-controller") (ne $sealed.image.tag "0.38.4") (not (empty $sealed.image.pullSecrets)) -}}{{ fail "Sealed Secrets image version is locked to 0.38.4" }}{{- end -}}
